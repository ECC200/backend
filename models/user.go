...
type User struct {
	...
	MedicationStatus    string             `json:"medication_status" firestore:"medication_status"`       //服薬中の薬
	DoctorComment       string             `json:"doctor_comment" firestore:"doctor_comment"`             //主治医のコメント
	HospitalDestination string             `json:"hospital_destination" firestore:"hospital_destination"` //かかりつけの病院
	Specialty           string             `json:"specialty" firestore:"specialty"`                       //何科
	DisabilityGrade     string             `json:"disability_grade" firestore:"disability_grade"`         //障がい者等級
}
